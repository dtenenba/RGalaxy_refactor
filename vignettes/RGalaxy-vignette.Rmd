...
* While it's good to have an `example` section, this section
...
Clickin on it should show something like Figure 2. You can download
...
argument to each parameter. Another, subtler difference is that we have added
...
present, you can do that from your Galaxy home directory as follows:
...
and its man page live a package (the `RGalaxy` package). 
...
## Best practices - extended example?

## Using Rserve for better performance

Galaxy runs tools by running scripts in various languages
